...
RESOURCE_KEYS = [ ACTIVITY_STATE_KEY, AIR_QUALITY_KEY, AUDIO_DETECTED_KEY, BATTERY_KEY,
                            BRIGHTNESS_KEY, CONNECTION_KEY, CHARGING_KEY, FLIP_KEY, HUMIDITY_KEY,
...
RESOURCE_UPDATE_KEYS = [ ACTIVITY_STATE_KEY, AIR_QUALITY_KEY, AUDIO_DETECTED_KEY, BATTERY_KEY, CHARGING_KEY,
